...
const About = () => {
  return (
    <Layout>
      <PageBanner pageName={"About Nutrients"} />
      {/* Page Banner End */}
      {/* About Section Start */}
            ...
            <div className="col-lg-6">
              <div className="about-three-content rmb-35 wow fadeInLeft delay-0-2s">
                <div className="section-title mb-20">
                  <span className="sub-title mb-20">About Nutrients</span>
                  <h2>Learn about <br></br>What You eat</h2>
                </div>
                <p>
                Discover how the foods you choose create beauty from the inside out. 
                Explore delicious recipes, expert insights, and the transformative power of whole food nutrition.
                </p>
              ...
              <div className="feature-item wow fadeInUp delay-0-2s">
                <div className="content">
                  ...
                  <p>
                      ...
                      Organic vegetables, 
                      like conventionally grown ones, are rich in essential nutrients that contribute to overall health.
                  </p>
                </div>
                <Link href="/service-details">
